 ...
 * @returns {Promise<{profile: object|null, tasks: Array, capsules: Array, achievements: Array, settings: object}>}
 */
export async function readAll() {
  const [profile, tasks, capsules, achievements, settings] = await Promise.all([
